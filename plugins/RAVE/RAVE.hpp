...
class AbstractBase : public SCUnit {
public:
    AbstractBase() {}
    ~AbstractBase() {}
    virtual void myfn() = 0; 
...
class SimpleBase : public SCUnit {
public:
    SimpleBase() {}
    ~SimpleBase() {}
};
...
// crash
class TestDummy : public Base {
public:
    TestDummy() {mCalcFunc = make_calc_function<TestDummy, &TestDummy::next>();}
    ~TestDummy() {}
    void myfn() {}
    void next(int nSamples) {}
};
...
// crash
class TestDummy2 : public AbstractBase {
public:
    TestDummy2() {mCalcFunc = make_calc_function<TestDummy2, &TestDummy2::next>();}
    ~TestDummy2() {}
    void myfn() {}
    void next(int nSamples) {}
};
...
// no crash
class TestDummy3 : public SCUnit {
public:
    TestDummy3() {mCalcFunc = make_calc_function<TestDummy3, &TestDummy3::next>();}
    ~TestDummy3() {}
    void myfn() {}
    void next(int nSamples) {}
};
...
// no crash
class TestDummy4 : public SimpleBase {
public:
    TestDummy4() {mCalcFunc = make_calc_function<TestDummy4, &TestDummy4::next>();}
    ~TestDummy4() {}
    void myfn() {}
    void next(int nSamples) {}
};
